    ...
    <style type="text/css">
        * {
        ...
        .back {
            width: 870mm;
            height: 548mm;
            background-image: url(<?= base_url('assets/images/layouts/images/mahrom-front.jpg') ?>);
        ...
        .belakang {
            width: 870mm;
            height: 547.5mm;
            background-image: url(<?= base_url('assets/images/layouts/images/mahrom-behind.jpg') ?>);
            background-repeat: no-repeat;
            background-size: cover;
        }
    ...
    <div class="back">
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="foto">
                    <img src="<?= base_url() ?>assets/images/apps/fotowali/<?= $data->foto ?>.jpg" alt="" class="fotoWali">
                </div>
            </div>
        </div>
        <div class="rowbawah">
