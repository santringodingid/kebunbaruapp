                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="float-right mt-5">
                                            ...
                                            <a class="btn btn-app bg-primary" href="<?= base_url() ?>santribaru/print/<?= encrypt_url($dataentri->id_santri) ?>" target="_blank">
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body ui-front">
                    <form action="<?= base_url() ?>santribaru/editdatasantri" method="POST" autocomplete="off" id="formeditsantri">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="niksantri" class="col-sm-4 col-form-label">No.
                                        (KTP/NIK)/KK</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control inputdatasantri" id="niksantri" name="niksantri" autofocus data-inputmask="'mask' : '9999999999999999'" data-mask="" tabindex="1" value="<?= $dataentri->nik_santri; ?>">
                                    </div>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control inputdatasantri" id="kksantri" name="kksantri" autofocus data-inputmask="'mask' : '9999999999999999'" data-mask="" tabindex="2" value="<?= $dataentri->kk_santri; ?>">
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label for="tempatlahirsantri" class="col-sm-4 col-form-label">Tempat
                                        Lahir</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control inputdatasantri" id="tempatlahirsantri" name="tempatlahirsantri" tabindex="4" value="<?= $dataentri->tempat_lahir_santri; ?>">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control inputdatasantri" id="namasantri" name="namasantri" tabindex="3" value="<?= $dataentri->nama_santri; ?>">
                                    </div>
                                </div>
                                <?php
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <select name="tanggallahirsantri" id="tanggallahirsantri" class="form-control inputdatasantri" tabindex="5">
                                            ...
                                            for ($i = 1; $i <= 31; $i++) {
                                            ?>
                                                <option value="<?= sprintf('%02d', $i); ?>" <?= ($pecahtgl[2] == sprintf('%02d', $le++)) ? 'selected' : ''; ?>>
                                                    <?= sprintf('%02d', $i); ?>
                                                </option>
                                            <?php } ?>
                                        </select>
                                    ...
                                    <div class="col-sm-3">
                                        <select name="bulanlahirsantri" id="bulanlahirsantri" class="form-control inputdatasantri" tabindex="6">
                                            ...
                                            for ($p = 1; $p <= 12; $p++) {
                                            ?>
                                                <option value="<?= sprintf('%02d', $p); ?>" <?= ($pecahtgl[1] == sprintf('%02d', $ke++)) ? 'selected' : ''; ?>>
                                                    <?= $bulan[$p]; ?>
                                                </option>
                                            <?php } ?>
                                        </select>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control inputdatasantri" id="provinsisantri" name="provinsisantri" tabindex="8" value="<?= $dataentri->provinsi_santri ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control inputdatasantri" id="kecamatansantri" name="kecamatansantri" tabindex="10" value="<?= $dataentri->kecamatan_santri ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control inputdatasantri" id="dusunsantri" name="dusunsantri" tabindex="12" value="<?= $dataentri->dusun_santri ?>">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control inputdatasantri" id="kabupatensantri" name="kabupatensantri" tabindex="9" value="<?= $dataentri->kabupaten_santri ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="desasantri" class="col-sm-4 col-form-label">Desa/Kelurahan</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control inputdatasantri" id="desasantri" name="desasantri" tabindex="11" value="<?= $dataentri->desa_santri ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="rtsantri" class="col-sm-4 col-form-label">RT/RW/Kode
                                        Pos</label>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control inputdatasantri" id="rtsantri" data-inputmask="'mask' : '999'" data-mask="" name="rtsantri" tabindex="13" value="<?= $dataentri->rt_santri ?>">
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control inputdatasantri" id="rwsantri" data-inputmask="'mask' : '999'" data-mask="" name="rwsantri" tabindex="14" value="<?= $dataentri->rw_santri ?>">
                                    </div>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control inputdatasantri" id="kodepossantri" name="kodepossantri" value="<?= $dataentri->kode_pos_santri; ?>" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="pendidikansantri" id="pendidikansantri" class="form-control inputdatasantri" tabindex="15">
                                            ...
                                            <option value="Tidak Tamat SD/Sederajat" <?= ($dataentri->pendidikan_akhir_santri == 'Tidak Tamat SD/Sederajat') ? 'selected' : ''; ?>>
                                                Tidak Tamat SD/Sederajat
                                            </option>
                                            <option value="Tamat SD/Sederajat" <?= ($dataentri->pendidikan_akhir_santri == 'Tamat SD/Sederajat') ? 'selected' : '' ?>>
                                                Tamat SD/Sederajat</option>
                                            <option value="Tamat SMP/Sederajat" <?= ($dataentri->pendidikan_akhir_santri == 'Tamat SMP/Sederajat') ? 'selected' : '' ?>>
                                                Tamat SMP/Sederajat</option>
                                            <option value="Tamat SMA/Sederajat" <?= ($dataentri->pendidikan_akhir_santri == 'Tamat SMA/Sederajat') ? 'selected' : '' ?>>
                                                Tamat SMA/Sederajat</option>
                                            <option value="Sarjana/Diploma" <?= ($dataentri->pendidikan_akhir_santri == 'Sarjana/Diploma') ? 'selected' : '' ?>>
                                                Sarjana/Diploma</option>
                                            <option value="Pasca Sarjana" <?= ($dataentri->pendidikan_akhir_santri == 'Pasca Sarjana') ? 'selected' : '' ?>>
                                                Pasca
                                                Sarjana</option>
                                            <option value="Pondok Pesantren" <?= ($dataentri->pendidikan_akhir_santri == 'Pondok Pesantren') ? 'selected' : '' ?>>
                                                Pondok
                                                Pesantren</option>
                                            <option value="Lainnya" <?= ($dataentri->pendidikan_akhir_santri == 'Lainnya') ? 'selected' : '' ?>>
                                                Lainnya
                                            </option>
                                        </select>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8 pt-2">
                                        <div class="icheck-primary d-inline">
                                            <input type="radio" name="rencanadomisili" id="radioPrimary1" value="P2K" tabindex="16" <?= ($dataentri->status_domisili_santri == 'P2K') ? 'checked' : '';; ?>>
                                            <label for="radioPrimary1" style="font-weight: 500;">P2K (Asrama)</label>
                                        </div>
                                        <div class="icheck-primary d-inline ml-4">
                                            <input type="radio" name="rencanadomisili" id="radioPrimary2" value="LP2K" <?= ($dataentri->status_domisili_santri == 'LP2K') ? 'checked' : ''; ?>>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <select name="kelasdiniyahsantri" id="kelasdiniyahsantri" class="form-control inputdatasantri" tabindex="19">
                                            ...
                                            <option value="Jilid" <?= ($dataentri->kelas_diniyah == 'Jilid') ? 'selected' : ''; ?>>Jilid
                                            </option>
                                            <option value="Takhossus" <?= ($dataentri->kelas_diniyah == 'Takhossus') ? 'selected' : ''; ?>>
                                                Takhossus
                                            </option>
                                            <?php
                                            $kaa = 1;
                                            for ($ke = 1; $ke <= 6; $ke++) {
                                            ?>
                                                <option value="<?= $ke; ?>" <?= ($dataentri->kelas_diniyah == $kaa++) ? 'selected' : ''; ?>>
                                                    <?= $ke; ?>
                                                </option>
                                            <?php } ?>
                                        </select>
                                    ...
                                    <div class="col-sm-5">
                                        <select name="tingkatdiniyahsantri" id="tingkatdiniyahsantri" class="form-control inputdatasantri" tabindex="20">
                                            ...
                                            ?>
                                                    <option value="<?= $dpd->nama_datapendidikan ?>" <?= ($dataentri->tingkat_diniyah == $dpd->nama_datapendidikan) ? 'selected' : '' ?>>
                                ...
                                <div class="form-group row">
                                    <label for="ayahsantri" class="col-sm-4 col-form-label">Nama
                                        Ayah</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control inputdatasantri" id="ayahsantri" name="ayahsantri" tabindex="23" value="<?= $dataentri->ayah_santri; ?>">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="nomorkamarsantri" class="col-sm-4 col-form-label">Rencana
                                        Kamar</label>
                                    <div class="col-sm-2">
                                        <select name="nomorkamarsantri" id="nomorkamarsantri" <?= ($dataentri->status_domisili_santri == 'LP2K') ? 'disabled' : '' ?> class="form-control inputdatasantri" tabindex="17">
                                            <option value="">..::..</option>
                                            <?php
                                            $kkk = 1;
                                            for ($k = 1; $k <= 10; $k++) {
                                            ?>
                                                <option value="<?= $k; ?>" <?= ($dataentri->nomor_kamar_santri == $kkk++) ? 'selected' : ''; ?>>
                                                    <?= $k; ?>
                                                </option>
                                    ...
                                    <div class="col-sm-6">
                                        <select name="daerahsantri" id="daerahsantri" class="form-control inputdatasantri" tabindex="18" <?= ($dataentri->status_domisili_santri == 'LP2K') ? 'disabled' : '' ?>>
                                            <option value="">..::Pilih::..</option>
                                            <?php
                                            if ($datakamar) {
                                                foreach ($datakamar as $datakamar) {
                                            ?>
                                                    <option value="<?= $datakamar->nama_kamar; ?>" <?= ($dataentri->domisili_santri == $datakamar->nama_kamar) ? 'selected' : ''; ?>>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <select name="kelasformalsantri" id="kelasformalsantri" class="form-control inputdatasantri" tabindex="21">
                                            ...
                                            for ($ke = 1; $ke <= 6; $ke++) {
                                            ?>
                                                <option value="<?= $ke; ?>" <?= ($dataentri->kelas_formal == $llll++) ? 'selected' : ''; ?>>
                                                    <?= $ke; ?>
                                                </option>
                                            <?php } ?>
                                            <option <?= ($dataentri->kelas_formal == 'Lulus') ? 'selected' : ''; ?> value="Lulus">Lulus</option>
                                        </select>
                                    </div>
                                    <div class="col-sm-6">
                                        <select name="tingkatformalsantri" id="tingkatformalsantri" class="form-control inputdatasantri" tabindex="22">
                                            ...
                                            ?>
                                                    <option value="<?= $dpf->nama_datapendidikan ?>" <?= ($dataentri->tingkat_formal == $dpf->nama_datapendidikan) ? 'selected' : '' ?>>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control inputdatasantri" id="ibusantri" name="ibusantri" tabindex="24" value="<?= $dataentri->ibu_santri ?>">
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="modal-editwali" aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body ui-front">
                    <form id="formeditwali" action="<?= base_url() ?>santribaru/EditDataWali" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control inputdatasantri" id="nikwali" name="nikwali" autofocus data-inputmask="'mask' : '9999999999999999'" data-mask="" tabindex="25" value="<?= $dataentri->nik_walisantri ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control inputdatasantri" id="namawali" name="namawali" tabindex="26" value="<?= $dataentri->nama_walisantri ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="nomorhpwali" class="col-sm-4 col-form-label">Nomor
                                        HP</label>
                                    <div class="col-sm-8">
                                        <input type="text" data-inputmask="'mask' : '9999-9999-9999'" data-mask="" class="form-control inputdatasantri" id="nomorhpwali" name="nomorhpwali" tabindex="27" value="<?= $dataentri->nomor_hp_walisantri ?>">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control inputdatasantri" id="provinsiwali" name="provinsiwali" tabindex="28" value="<?= $dataentri->provinsi_walisantri ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control inputdatasantri" id="kecamatanwali" name="kecamatanwali" tabindex="30" value="<?= $dataentri->kecamatan_walisantri ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control inputdatasantri" id="dusunwali" name="dusunwali" tabindex="32" value="<?= $dataentri->dusun_walisantri ?>">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control inputdatasantri" id="kabupatenwali" name="kabupatenwali" tabindex="29" value="<?= $dataentri->kabupaten_walisantri ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="desawali" class="col-sm-4 col-form-label">Desa/Kelurahan</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control inputdatasantri" id="desawali" name="desawali" tabindex="31" value="<?= $dataentri->desa_walisantri ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="rtwali" class="col-sm-4 col-form-label">RT/RW/Kode
                                        Pos</label>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control inputdatasantri" id="rtwali" data-inputmask="'mask' : '999'" data-mask="" name="rtwali" tabindex="33" value="<?= $dataentri->rt_walisantri ?>">
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control inputdatasantri" id="rwwali" data-inputmask="'mask' : '999'" data-mask="" name="rwwali" tabindex="34" value="<?= $dataentri->rw_walisantri ?>">
                                    </div>
                                    <div class="col-sm-4">
                                        <input type="text" readonly class="form-control inputdatasantri" id="kodeposwali" name="kodeposwali" value="<?= $dataentri->kode_pos_walisantri ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="pendidikanwali" id="pendidikanwali" class="form-control inputdatasantri" tabindex="35">
                                            <option value="">..::..</option>
                                            <option value="Tidak Tamat SD/Sederajat" <?= ($dataentri->pendidikan_akhir_walisantri == 'Tidak Tamat SD/Sederajat') ? 'selected' : ''; ?>>
                                                Tidak Tamat
                                                SD/Sederajat
                                            </option>
                                            <option value="Tamat SD/Sederajat" <?= ($dataentri->pendidikan_akhir_walisantri == 'Tamat SD/Sederajat') ? 'selected' : ''; ?>>
                                                Tamat
                                                SD/Sederajat</option>
                                            <option value="Tamat SMP/Sederajat" <?= ($dataentri->pendidikan_akhir_walisantri == 'Tamat SMP/Sederajat') ? 'selected' : ''; ?>>
                                                Tamat
                                                SMP/Sederajat</option>
                                            <option value="Tamat SMA/Sederajat" <?= ($dataentri->pendidikan_akhir_walisantri == 'Tamat SMA/Sederajat') ? 'selected' : ''; ?>>
                                                Tamat
                                                SMA/Sederajat</option>
                                            <option value="Sarjana/Diploma" <?= ($dataentri->pendidikan_akhir_walisantri == 'Sarjana/Diploma') ? 'selected' : ''; ?>>
                                                Sarjana/Diploma</option>
                                            <option value="Pasca Sarjana" <?= ($dataentri->pendidikan_akhir_walisantri == 'Pasca Sarjana') ? 'selected' : ''; ?>>
                                                Pasca
                                                Sarjana</option>
                                            <option value="Pondok Pesantren" <?= ($dataentri->pendidikan_akhir_walisantri == 'Pondok Pesantren') ? 'selected' : ''; ?>>
                                                Pondok
                                                Pesantren</option>
                                            <option value="Lainnya" <?= ($dataentri->pendidikan_akhir_walisantri == 'Lainnya') ? 'selected' : ''; ?>>
                                                Lainnya
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="pekerjaanwali" id="pekerjaanwali" class="form-control inputdatasantri" tabindex="36">
                                            <option value="">..::..</option>
                                            <option value="BELUM/TIDAK BEKERJA" <?= ($dataentri->pekerjaan_walisantri == 'BELUM/TIDAK BEKERJA') ? 'selected' : ''; ?>>
                                                BELUM/TIDAK BEKERJA</option>
                                            <option value="USTADZ/MUBALIGH" <?= ($dataentri->pekerjaan_walisantri == 'USTADZ/MUBALIGH') ? 'selected' : ''; ?>>
                                                USTADZ/MUBALIGH</option>
                                            <option value="WIRASWASTA" <?= ($dataentri->pekerjaan_walisantri == 'WIRASWASTA') ? 'selected' : ''; ?>>
                                                WIRASWASTA
                                            </option>
                                            <option value="NELAYAN/PERIKANAN" <?= ($dataentri->pekerjaan_walisantri == 'NELAYAN/PERIKANAN') ? 'selected' : ''; ?>>
                                                NELAYAN/PERIKANAN</option>
                                            <option value="PETANI/PEKEBUN" <?= ($dataentri->pekerjaan_walisantri == 'PETANI/PEKEBUN') ? 'selected' : ''; ?>>
                                                PETANI/PEKEBUN</option>
                                            <option value="PELAJAR/MAHASISWA" <?= ($dataentri->pekerjaan_walisantri == 'PELAJAR/MAHASISWA') ? 'selected' : ''; ?>>
                                                PELAJAR/MAHASISWA</option>
                                            <option value="KARYAWAN SWASTA" <?= ($dataentri->pekerjaan_walisantri == 'KARYAWAN SWASTA') ? 'selected' : ''; ?>>
                                                KARYAWAN
                                                SWASTA</option>
                                            <option value="KARYAWAN HONORER" <?= ($dataentri->pekerjaan_walisantri == 'KARYAWAN HONORER') ? 'selected' : ''; ?>>
                                                KARYAWAN
                                                HONORER</option>
                                            <option value="PEGAWAI NEGERI SIPIL" <?= ($dataentri->pekerjaan_walisantri == 'PEGAWAI NEGERI SIPIL') ? 'selected' : ''; ?>>
                                                PEGAWAI NEGERI SIPIL</option>
                                            <option value="LAINNYA" <?= ($dataentri->pekerjaan_walisantri == 'LAINNYA') ? 'selected' : ''; ?>>
                                                LAINNYA
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="hubunganwali" id="hubunganwali" class="form-control inputdatasantri" tabindex="37">
                                            <option value="">..::..</option>
                                            <option value="Orang Tua Kandung" <?= ($dataentri->hubungan_wali == 'Orang Tua Kandung') ? 'selected' : ''; ?>>
                                                Orang Tua
                                                Kandung</option>
                                            <option value="Kakek/Nenek" <?= ($dataentri->hubungan_wali == 'Kakek/Nenek') ? 'selected' : ''; ?>>
                                                Kakek/Nenek
                                            </option>
                                            <option value="Paman/Bibi" <?= ($dataentri->hubungan_wali == 'Paman/Bibi') ? 'selected' : ''; ?>>
                                                Paman/Bibi
                                            </option>
                                            <option value="Saudara Kandung" <?= ($dataentri->hubungan_wali == 'Saudara Kandung') ? 'selected' : ''; ?>>
                                                Saudara
                                                Kandung</option>
                                            <option value="Orang Tua Tiri" <?= ($dataentri->hubungan_wali == 'Orang Tua Tiri') ? 'selected' : ''; ?>>
                                                Orang Tua
                                                Tiri</option>
                                            <option value="Lainnya" <?= ($dataentri->hubungan_wali == 'Lainnya') ? 'selected' : ''; ?>>
                                                Lainnya
                                            </option>
                                        </select>
                                    </div>
                        ...
                        <input type="hidden" name="totalnik" id="totalnik" value="<?= $total ?>">
                    </form>
                </div>
                <div class="modal-footer">
                    <?php
                    ...
                    ?>
                        <div class="custom-control custom-checkbox">
                            ...
                            <label style="font-weight: normal;" for="customCheckbox2" class="custom-control-label text-primary">Tercatat ada <?= $total ?> santri yang terhubung dengan wali ini. Pilih jika ingin update data santri yang terhubung dengan wali ini</label>
                        </div>
                    <?php } ?>
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Batal</button>
